...
import cn.wulin.brace.remoting.exchange.support.ExchangeHandlerDispatcher;
import cn.wulin.brace.remoting.exchange.support.Replier;
import cn.wulin.brace.remoting.transport.ChannelHandlerAdapter;
import cn.wulin.ioc.Constants;
import cn.wulin.ioc.URL;
import cn.wulin.ioc.extension.InterfaceExtensionLoader;
import cn.wulin.ioc.logging.Version;
...
public class Exchangers {
    ...
    public static Exchanger getExchanger(String type) {
        return InterfaceExtensionLoader.getExtensionLoader(Exchanger.class).getExtension(type);
    }
