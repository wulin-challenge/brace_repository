...
public class SharedReentrantReadWriteLock2 {
	...
	public SharedReentrantReadWriteLock2(String lockRootNode) {
		this(lockRootNode, new ZookeeperCuratorEventAdapter());
	}
	
	public SharedReentrantReadWriteLock2(String lockRootNode,ZookeeperCuratorEvent zookeeperCuratorEvent) {
		...
		// 创建节点并添加监听
		createNodeAndAddListener(zookeeperCuratorEvent);
	}
	 ...
	 * 创建节点并添加监听
	 */
	private void createNodeAndAddListener(ZookeeperCuratorEvent zookeeperCuratorEvent) {
